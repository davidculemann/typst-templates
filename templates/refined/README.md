...
A contemporary editorial serif, confident rather than formal

<div align="center">
  <img alt="The Refined CV template" src="preview.webp" width="480" />
</div>
...
Needs Typst 0.12 or newer. Set in **Source Serif 4**; if you do not have it installed, change the `font:` argument in the show rule to a family you do have.
...
[hosted builder](https://www.jobsprout.ai/resume-templates/refined) with AI editing and ATS scoring.
