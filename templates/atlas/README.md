...
An accent header band above an uncoloured two-column body

<div align="center">
  <img alt="The Atlas CV template" src="preview.webp" width="480" />
</div>
...
Needs Typst 0.12 or newer. Set in **Nunito Sans**; if you do not have it installed, change the `font:` argument in the show rule to a family you do have.
...
[hosted builder](https://www.jobsprout.ai/resume-templates/atlas) with AI editing and ATS scoring.
