// Public API for @preview/vertex-cv.
//
// The design itself lives in vertex.typ and matches the source JobSprout
...
#import "vertex.typ": vertex-cv as resume, masthead, cv-section, vertex-twoup, vertex-entry, vertex-cred, vertex-language
