...
A centred serif masthead with short sections set two-up

<div align="center">
  <img alt="The Vertex CV template" src="preview.webp" width="480" />
</div>
...
Needs Typst 0.12 or newer. Set in **EB Garamond**; if you do not have it installed, change the `font:` argument in the show rule to a family you do have.
...
[hosted builder](https://www.jobsprout.ai/resume-templates/vertex) with AI editing and ATS scoring.
