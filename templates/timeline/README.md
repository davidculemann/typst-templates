...
A vertical timeline with an accent node marking each role

<div align="center">
  <img alt="The Timeline CV template" src="preview.webp" width="480" />
</div>
...
Needs Typst 0.12 or newer. Set in **Bitter**; if you do not have it installed, change the `font:` argument in the show rule to a family you do have.
...
[hosted builder](https://www.jobsprout.ai/resume-templates/timeline) with AI editing and ATS scoring.
