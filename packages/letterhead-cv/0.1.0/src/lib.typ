// Public API for @preview/letterhead-cv.
//
// The design itself lives in letterhead.typ and matches the source JobSprout
...
#import "letterhead.typ": letterhead-cv as resume, masthead, cv-section, letterhead-entry, letterhead-language
