...
A full-bleed accent header band across the top of the page

<div align="center">
  <img alt="The Horizon CV template" src="preview.webp" width="480" />
</div>
...
Needs Typst 0.12 or newer. Set in **Roboto**; if you do not have it installed, change the `font:` argument in the show rule to a family you do have.
...
[hosted builder](https://www.jobsprout.ai/resume-templates/horizon) with AI editing and ATS scoring.
