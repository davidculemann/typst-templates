// Letterhead CV, a Typst resume template.
//
...
// Edit in a browser: https://www.jobsprout.ai/resume-templates/letterhead
...
#masthead(author: "Jane Smith", profession: "Director of Product", contact: { link("mailto:jane.smith@example.com")[jane.smith\@example.com] + h(0.5em) + sym.bar.v + h(0.5em) + [+1 (415) 555 0148] + h(0.5em) + sym.bar.v + h(0.5em) + [San Francisco, CA] }, accent-color: "#4a5d46")

#cv-section("Summary", accent-color: "#4a5d46")
...
#cv-section("Education", accent-color: "#4a5d46")
...
#cv-section("Experience", accent-color: "#4a5d46")
...
#cv-section("Projects", accent-color: "#4a5d46")
...
#cv-section("Certifications", accent-color: "#4a5d46")
...
#cv-section("Awards", accent-color: "#4a5d46")
